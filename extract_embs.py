...
# fonction pour extraire caract
#graverver les img normalisée dans un ficher
def extract_embedding(input_dir, output_dir, emb_file, norm_dir, model_name=model_name):
    os.makedirs(output_dir, exist_ok=True) #creation du fichier de sortie
    os.makedirs(norm_dir, exist_ok=True)   #creation du fichier de normalisation
    try:
